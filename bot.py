...
async def main():
    ...
    while True:
        ...
        await bot.send_message(chat_id=CHAT_ID, text="DEBUG: běžím")
        ...
        for game in games:
            ...
            live = requests.get(f"https://statsapi.mlb.com/api/v1.1/game/{game_id}/feed/live").json()
            ...
            try:
                ...
                # 👉 ODDS – najdi nejlepší OVER 6.5–8.5
                best_over_odds = None
                best_line = None
                ...
                if (
                    ...
                    and (
                        (home_lob >= 3 and home_traffic >= 6)
                        and
                        (away_lob >= 2 and away_traffic >= 4)
                    )
